...
</head><!-- Wappler include  head-page="index.php" appconnect="local" is="dmx-app" bootstrap4="cdn" fontawesome_4="cdn" jquery_slim_33="cdn" components="{&quot;dmxBootstrap4Navigation&quot;:{},&quot;dmxAnimateCSS&quot;:{}}"-->
<header class="univ--header fixed-top">
      <div class="container univ--header--container">
        <nav class="navbar navbar-expand-lg univ--header--container--navbar bg-transparent navbar-dark pl-0 pr-0">
          <button class="navbar-toggler univ--header--container--navbar--toggler text-light pt-0 pb-0 pl-0 pr-0" type="button" data-toggle="collapse" data-target="#collapse1" aria-controls="collapse1" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon unv--header--container--navbar--toggler--icon"></span>
          </button>
